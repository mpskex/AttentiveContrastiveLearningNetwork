...
if __name__ == '__main__':
    ...
    p.add_argument('--backbone', default=None, type=str, help='Backbone that the network will use')
    ...
    c.backbone = param.backbone if param.backbone is not None else c.backbone
